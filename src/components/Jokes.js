...
const Excuser = () => {
  const programmingUrl =
    "https://v2.jokeapi.dev/joke/Any?blacklistFlags=religious&type=single&idRange=0-319";
        ...
        </div>
        {
          <>
            <div className=" card mb-3 mt-5 mx-auto shadow col-lg-6 col-sm-12 col-md-10 ">
              <h3 className="card-header mt-2 text-warning text-center">
                {categories}
              </h3>
            ...
            <div className="text-center">
              <button onClick={getData} className="btn btn-warning   btn-lg">
                Next
              </button>
            </div>
          </>
